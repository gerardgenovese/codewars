...
// the first a buffer with length exactly the same as the second parameter, the original string. You don't have to worry with 
...
function removeChar(str){
      ...
      for (let i = 0; i < str.length; i++) {
        let str2 = str.slice(1, str.length - 1);
        return str2;
      }  
